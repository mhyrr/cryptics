...
| H16 | Interior cells alternate vowel and consonant downward from the seed word, and beyond that class the letter is a free choice. | supported | Predict class and letter for cells blank in Mathers; score against a second witness. A rule that lifts letter accuracy well above the class baseline would refute the second clause. | Class 153 of 193 on Dehn interior cells, frozen beforehand; letter 61 of 193 against 48 baseline. Row two of 5 × 5 squares starts vowel-R in 14 of 35, as in AREPO. Exp. 13. 2026-09-20, second session: the second clause survived five frozen attempts to refute it. 2.92 bits per orbit given class; chapter 0.15 bit, prince and letter above 0.06, seed reuse at chance, AREPO R not positional, no interior excess in witness disagreement. Best accuracy 32 %. Exp. 16. |
...
| H22 | The dictionary's Greek glosses, romanized, supply some seeds. | supported | Frozen romanization against unmatched top rows with a shuffle control. | Frozen scheme 5 exact against 2.2. Post hoc itacist reading 6 against 0.5 (THIRAMA, PARADILON, ALAMPIS, KIXALIS). The post hoc part needs a blind repeat on a German witness. Exp. 17. |
